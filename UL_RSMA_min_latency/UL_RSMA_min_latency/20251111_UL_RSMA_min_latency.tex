...
\begin{equation*}
	\begin{aligned}
		C_{k,\ell}(\F_{k,\ell}) &= \log(1+\rho) \\
		 &=\log_2\det(\I+\sigma^{-2}\F_{k,\ell}\F_{k,\ell}^H) \\
		V_{k,\ell}(\F_{k,\ell}) &= \frac{1}{2}\frac{\rho(\rho+2)}{(1+\rho)^2}(\log^2(e)) \\
		&= \frac{1}{2} (1-(1+\rho)^{-2})\log^2(e) \\
		&= \frac{1}{2} \text{tr}(\I - (\I+\sigma^{-2}\F_{k,\ell}\F_{k,\ell}^H)^{-2})\log^2(e)
	\end{aligned}
\end{equation*}
